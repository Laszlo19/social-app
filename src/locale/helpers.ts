...
export function sanitizeAppLanguageSetting(appLanguage: string): AppLanguage {
  ...
  for (const lang of langs) {
    switch (fixLegacyLanguageCode(lang)) {
      ...
      // New languages
      case 'ab':
        return AppLanguage.ab
      case 'af':
        return AppLanguage.af
      case 'am':
      ...
      case 'co':
        return AppLanguage.co
      case 'cs':
        return AppLanguage.cs
      case 'et':
        return AppLanguage.et
      case 'fa':
      ...
      case 'hy':
        return AppLanguage.hy
      case 'is':
        return AppLanguage.is
      case 'ka':
      ...
      case 'krc':
        return AppLanguage.krc
      case 'ky':
        return AppLanguage.ky
      case 'lb':
        return AppLanguage.lb
      case 'lo':
        return AppLanguage.lo
      case 'lt':
        return AppLanguage.lt
      case 'lv':
        return AppLanguage.lv
      case 'mi':
        return AppLanguage.mi
      case 'mk':
      ...
      case 'se':
        return AppLanguage.se
      case 'sk':
        return AppLanguage.sk
      case 'sl':
        return AppLanguage.sl
      case 'sq':
        return AppLanguage.sq
      case 'sr':
      ...
      case 'xh':
        return AppLanguage.xh
      case 'yo':
        return AppLanguage.yo
      case 'yue':
